...
class StatusDistributionDonutChart extends ApexChartWidget
{
    protected static ?string $chartId = 'statusDistributionDonutChart';
    ...
    protected function getOptions(): array
    {
        $results = DB::table('patient')
            ->leftJoin('status', 'patient.patient_status', '=', 'status.status_id')
            ->whereNull('patient.deleted_at')
            ->selectRaw('status.status as label, COUNT(*) as count')
