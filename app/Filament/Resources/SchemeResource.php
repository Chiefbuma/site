...
class SchemeResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Section::make('Scheme Details')
                    ->schema([
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('restore')
                    ...
                    ->modalHeading('Restore Scheme')
                    ->modalSubheading('Are you sure you want to restore this scheme?'),
                ...
                Tables\Actions\Action::make('forceDelete')
                    ...
                    ->color('danger')
                    ->requiresConfirmation()
                    ->modalHeading('Permanently Delete Scheme')
                ...
                Tables\Actions\DeleteAction::make()
                    ...
                    ->icon('heroicon-o-trash')
                    ->requiresConfirmation()
                    ->modalHeading('Deactivate Scheme')
                    ->modalSubheading('The scheme will be moved to the deactivated list. You can restore it later.'),
            ])
            ->bulkActions([
                Tables\Actions\BulkActionGroup::make([
                    Tables\Actions\DeleteBulkAction::make()
                        ->label('Deactivate')
                        ->requiresConfirmation()
                        ->modalHeading('Deactivate Schemes')
                        ->modalSubheading('The selected schemes will be moved to the deactivated list. You can restore them later.'),
                    Tables\Actions\RestoreBulkAction::make()
                        ->label('Restore')
                        ->requiresConfirmation()
                        ->modalHeading('Restore Schemes')
                        ->modalSubheading('Are you sure you want to restore the selected schemes?'),
                    Tables\Actions\ForceDeleteBulkAction::make()
                        ->label('Delete')
                        ->requiresConfirmation()
                        ->modalHeading('Permanently Delete Schemes')
                        ->modalSubheading('This cannot be undone. All related data will be permanently deleted.'),
                ]),
            ])
    ...
    public static function getPages(): array
    {
        return [
            ...
            // 'view' => Pages\ViewScheme::route('/{record}'),
